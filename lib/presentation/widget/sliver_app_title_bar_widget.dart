...
class SliverAppTitleBarWidget extends StatelessWidget {
  final TodoListStateNotifier todoListStateNotifier;
  final SelectedTodosStateNotifier todoSelectionNotifier;
  const SliverAppTitleBarWidget(
      {super.key,
      required this.todoListStateNotifier,
      ...
      actions: todoSelectionNotifier.howManyTodoSelected() > 0
          ? [
              ...
              IconButton(
                ...
                onPressed: () async {
                  todoListStateNotifier.deleteMultipleTodos(
                      todosToBeDeletedById: todoSelectionNotifier.getIdSet());
              ...
              IconButton(
                ...
                onPressed: () async {
                  await todoListStateNotifier.markAsDone(
                      idSet: todoSelectionNotifier.getIdSet());
                  todoSelectionNotifier.reset();
                },
              ),
              IconButton(
          ...
          : [
              ...
              IconButton(
                ...
                onPressed: () {
                  int id = todoListStateNotifier.createNewBlankTodo().id;
